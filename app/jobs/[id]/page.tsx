...
export async function generateMetadata({ params }: { params: { id: string } }) {
  ...
  if (!data) return { title: "Вакансия не найдена" }
  ...
  return {
    title: `${data.channel_name || "DSML KZ"} - Вакансия`,
    description: description || "Читайте подробности вакансии от DSML Kazakhstan",
  }
}
