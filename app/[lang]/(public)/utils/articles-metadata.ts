...
export const articlesMetadata: ArticleMetadata[] = [
  {
    ...
    imageUrl: "https://swfxusemimczhhhfzjhc.supabase.co/storage/v1/object/public/articles/abu_kanabek.jpg",
