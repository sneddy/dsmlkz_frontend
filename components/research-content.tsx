...
import { ExternalLink, Users, Video, BookOpen, PlayCircle, Globe, Target, User, Lightbulb, Sparkles } from 'lucide-react'
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-black to-slate-800">
      ...
      <div className="container mx-auto px-4 py-16 space-y-20">
        ...
        <section className={`transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {goals.map((goal, index) => (
              <Card key={index} className="text-center bg-gradient-to-br from-slate-800/50 to-slate-900/50 backdrop-blur-sm border-slate-700/50 hover:shadow-2xl hover:shadow-[#00AEC7]/20 transition-all duration-300 hover:scale-105 group">
        ...
        <section className={`space-y-8 transition-all duration-1000 delay-300 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            <Card className="bg-gradient-to-br from-slate-800/50 to-slate-900/50 backdrop-blur-sm border-slate-700/50 hover:shadow-2xl hover:shadow-[#00AEC7]/20 transition-all duration-300 hover:scale-105 group">
              <CardHeader>
                ...
                <CardDescription className="text-gray-400">
                  {t("research.join.profile.description")}
                </CardDescription>
              </CardHeader>
            ...
            <Card className="bg-gradient-to-br from-slate-800/50 to-slate-900/50 backdrop-blur-sm border-slate-700/50 hover:shadow-2xl hover:shadow-[#00AEC7]/20 transition-all duration-300 hover:scale-105 group">
              <CardHeader>
                ...
                <CardDescription className="text-gray-400">
                  {t("research.join.spread.description")}
                </CardDescription>
              </CardHeader>
              <CardContent className="space-y-4">
                <div className="text-sm text-gray-400 space-y-2">
                ...
                <Button 
                  variant="outline" 
                  className="w-full border-[#00AEC7] text-[#00AEC7] hover:bg-[#00AEC7]/10 hover:shadow-lg hover:shadow-[#00AEC7]/30 transition-all duration-300 hover:scale-105"
        ...
        <section className={`space-y-8 transition-all duration-1000 delay-400 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
          <div className="text-center space-y-4">
            <div className="flex items-center justify-center gap-2 mb-4">
            ...
            <p className="text-lg text-gray-300 max-w-3xl mx-auto">
              {t("research.learning.description")}
            </p>
          </div>
                ...
                <Card className="h-full bg-gradient-to-br from-slate-800/50 to-slate-900/50 backdrop-blur-sm border-slate-700/50 hover:shadow-2xl hover:shadow-[#00AEC7]/20 transition-all duration-300 hover:scale-105 group">
                  <CardHeader className="pb-3">
                    <div className="flex items-center gap-2 mb-2">
                      <Badge className="bg-[#00AEC7]/10 text-[#00AEC7] border-[#00AEC7]/20">
                        Reading Club
                      </Badge>
                    </div>
        ...
        {/* Call to Action */}
        <section className={`text-center py-16 px-4 rounded-2xl transition-all duration-1000 delay-500 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`} 
                 style={{ 
          ...
          <div className="max-w-3xl mx-auto space-y-6">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <Button 
                ...
                variant="outline" 
                size="lg"
                className="border-white text-white hover:bg-white/10 hover:shadow-lg transition-all duration-300 hover:scale-105"
              >
