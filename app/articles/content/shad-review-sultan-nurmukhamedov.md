...
Более чем два года назад я прочитал пост Алена Баева в Сообществе о его учёбе в **Школе ��нализа данных (ШАД)**.  
...
Говорят, второй курс в ШАДе сильно легче первого. Так оно и есть. Из обязательных курсов тут Компьютерное Зрение или NLP. Взял оба. Третьим взял C++. По Компьютер��ому Зрению и NLP настрой был боевой. Должен же я хоть раз в ШАДе получить «Отлично». А вот по C++ настрой был скорее вялый. Долго рассуждая о полезности C++ для дата саентиста, решил все таки, что полезно, но не настолько, чтобы рваться на оценку выше зачета.
