...
> 
> На код-ревью, в отличие от контеста, твой код проверяют еще и на симпатичность. Код-ревью мне показались скорее больше про знание C++ и паттерны проектирования, чем про сами алгоритмы. За несколько итераций с проверяющим (обычно работник Яндекса) твой костыльный говнокод должен превратиться во что-то более менее приличное.
> 
> **Сложность**: Hard  
> **Моя оценка**: Зачет
